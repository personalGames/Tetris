 ...
 * Author: dorian
 *
 * Created on 30 de agosto de 2014, 15:32
 */
...
public:
    SShape();
    SShape(Square example);
    SShape(Square example, int state);
    
    SShape(const SShape& orig);
    virtual ~SShape();
...
private:
     ...
     */
    constexpr const static int INITIAL_COORDINATES[3][2]={{1,0},{1,1},{0,1}};
